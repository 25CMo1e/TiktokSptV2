...
const appendCasts = function (msgs: DyMessage[]) {
  console.log('CastList appendCasts 被调用:', msgs);
...
onMounted(() => {
  ...
  console.log('初始化后的 typeMap:', typeMap);
});
